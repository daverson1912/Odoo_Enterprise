...
class FedexRequest:
    ...
    def _decode_pricing(self, rating_result, request_currency=False):
        actual = next(filter(lambda d: d['rateType'] == rating_result['actualRateType'] and (not request_currency or d['currency'] == request_currency), rating_result['shipmentRateDetails']), {})
